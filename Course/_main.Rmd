...
### Prédicteur continue
#### Le modèle
Tout d'abord, nous devons déterminer quelle sera la variable dépendante (celle à expliquer) et quelle sera la variable indépendante (celle qui explique).\
\
...
knitr::include_graphics("Image/coeff.png")
```
...
```{r, echo=FALSE, out.width = '55%'}
knitr::include_graphics("Image/R2.png")
```
...
```{r, echo=FALSE, out.width = '55%'}
knitr::include_graphics("Image/coeff2.png")
```
...
```{r, echo=FALSE, out.width = '55%'}
knitr::include_graphics("Image/pvalue2.png")
```
...
```{r, echo=FALSE, out.width = '55%'}
knitr::include_graphics("Image/R22.png")
```
...
\
```{r, echo=FALSE, out.width = '55%'}
knitr::include_graphics("Image/Reg_multiple.png")
```
...
```{r, echo=FALSE, out.width = '55%'}
knitr::include_graphics("Image/Ajustement_c.png")
```
...
$Poids = \beta_0 + \beta_1 \times \text{1}_{\{Homme\}} + \beta_2 \times Taille + \beta_3 \times \text{1}_{\{Homme\}} \times Taille + \epsilon$
\
...
<!--chapter:end:02-interpretation.Rmd-->
